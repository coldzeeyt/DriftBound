...
(function () {
  ...
  const PALETTE = [
    ...
    { id: 'portal_cube', label: 'Cube', kind: 'obj', color: '#4fd1ff' },
    { id: 'portal_ship', label: 'Ship', kind: 'obj', color: '#ffb14f' },
    { id: 'portal_ball', label: 'Ball', kind: 'obj', color: '#c14fff' },
    { id: 'portal_ufo', label: 'UFO', kind: 'obj', color: '#5fffa0' },
    { id: 'portal_wave', label: 'Wave', kind: 'obj', color: '#ff5fa2' },
